...
export function useAddUser() {
  ...
  const addUser = async (userData) => {
    ...
    console.log("useAddUser: Datos recibidos:", {
      ...userData,
      password: "[REDACTED]",
    });
    setLoading(true);
    ...
    try {
      ...
      console.log(
        "useAddUser: Inicializando aplicación secundaria de Firebase Auth...",
      );
      ...
      console.log(
        "useAddUser: Intentando crear usuario en Authentication con el email:",
        userData.email,
      );
      ...
      console.log(
        "useAddUser: Usuario creado exitosamente en Auth. UID asignado:",
        user.uid,
      );

      // 3. Crear el documento en la colección 'users' de Firestore
      console.log(
        "useAddUser: Guardando datos complementarios en Firestore (colección 'users')...",
      );
      ...
      console.error(
        "useAddUser: ❌ Error durante el proceso de creación:",
        err,
      );
      ...
      if (secondaryApp) {
        try {
          ...
          console.error(
            "useAddUser: Error al limpiar app secundaria tras fallo:",
            cleanupErr,
          );
        }
      }
